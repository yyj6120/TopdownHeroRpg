...
public class BasicBehaviour : MonoBehaviour
{
    ...
    protected virtual void GetInputManager() { LinkedInputManager = FindObjectOfType(typeof(InputManager)) as InputManager; }

    public bool IsHorizontalMoving() { return LinkedInputManager.PrimaryMovement.x != 0; }

    public bool IsMoving() { return (LinkedInputManager.PrimaryMovement.x != 0) || (LinkedInputManager.PrimaryMovement.y != 0); }
